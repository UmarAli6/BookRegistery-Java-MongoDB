...
public class DbView extends VBox {
    ...
    private void initBooksTable() {
        ...
        TableColumn<Book, String> nrOfRatingsCol = new TableColumn<>("NrOfRs");
        ...
        booksTable.getColumns().addAll(titleCol, isbnCol, publishedCol, genreCol, ratingCol, nrOfRatingsCol, bookAddedByCol, authorNameCol, authorDobCol);
        ...
        nrOfRatingsCol.setPrefWidth(70.0);
        ...
        nrOfRatingsCol.setStyle("-fx-alignment: CENTER;");
        ...
        nrOfRatingsCol.setCellValueFactory(
                new Callback<CellDataFeatures<Book, String>, ObservableValue<String>>() {
            @Override
            public ObservableValue<String> call(CellDataFeatures<Book, String> data) {
                return new SimpleStringProperty(String.valueOf(data.getValue().getReviews().size()));
            }
        }
        );
    ...
    private void initMenus() {
        ...
        addItem.setOnAction(new EventHandler<ActionEvent>() {
            @Override
            public void handle(ActionEvent event) {
                controller.handleAddBookDialogEvent(null, false);
            }
        });
    ...
    protected void showWriteReviewDialog(Book bookToReview) {
        ...
        Optional<Book> result = writeReviewDialog.showAndWait();
